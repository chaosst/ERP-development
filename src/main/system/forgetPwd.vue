      ...
      <el-main>
        <div>
          ...
          <el-row style="margin-top:30px;text-align:center;" v-show="step == 1">
            ...
            <el-col span="8">
            <f-form :model="adata" :opt="aformOpt" ref="aForm" id="aForm" v-enter style="width:90%;">
              <f-form-item :opt="{prop:'email',label:'邮箱'}" class="inputItem">
                <el-input placeholder="请输入邮箱" id="email" name="email" v-model="adata.email">
                </el-input>
              </f-form-item>
              <f-form-item :opt="{prop:'validCode',label:'验证码'}" class="inputItem">
          ...
          <el-row style="margin-top:30px;text-align:center;" v-show="step == 2">
            ...
            <el-col span="8">
              <f-form :model="bdata" :opt="bformOpt" ref="bForm" id="bForm" v-enter style="width:90%;">
