  ...
  <div id="userInfoBox">
    ...
    <div class="right">
      ...
      <div v-if="linkTips==2">
        ...
        <f-form :model="pwdData" :opt="pwdFormOpt" style="width:500px;display: inline-block;margin-top:10px;margin-left: calc(50% - 250px);">
          <el-row>
            <f-form-item :opt="{label:'原始密码：',prop:'oldPassword'}">
              <el-input v-model="pwdData.oldPassword" type="password"></el-input>
            </f-form-item>
          </el-row>
          <el-row>
            <f-form-item :opt="{label:'新密码：',prop:'password'}">
              <el-input v-model="pwdData.password" type="password"></el-input>
            </f-form-item>
          </el-row>
          <el-row>
            <f-form-item :opt="{label:'重新输入密码：',prop:'validPassword'}">
